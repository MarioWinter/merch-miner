...
describe('authSlice', () => {
  ...
  it('setUser sets user, isAuthenticated, clears error', () => {
    const state = authReducer(
      undefined,
      setUser({ id: 1, email: 'a@b.com', first_name: 'Alice', avatar_url: null, is_staff: false, is_superuser: false }),
    );
    expect(state.user).toEqual({ id: 1, email: 'a@b.com', first_name: 'Alice', avatar_url: null, is_staff: false, is_superuser: false });
